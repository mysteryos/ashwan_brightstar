    ...
    <div class="card">
        <form class="form-horizontal" method="POST" action="{{action('AssignmentController@postCreate')}}" id="assignment_create_form">
            ...
            <div class="card-body card-padding">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="inputSubmissionDate">Submission_date*</label>
                    <div class="col-sm-10">
                        <div class="fg-line">
                            <input name="submission_date" type="text" placeholder="Submission_date" id="inputSubmission_date" class="form-control input-sm" value="{{old('submission_date')}}">
                        </div>
                    </div>
                </div>
