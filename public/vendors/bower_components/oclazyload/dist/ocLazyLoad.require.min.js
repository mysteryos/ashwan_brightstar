...
!function (e, n) {
    "use strict";
    var r = ["ng", "oc.lazyLoad"], o = {}, t = [], i = [], a = [], s = e.noop, u = {}, c = [], l = e.module("oc.lazyLoad", ["ng"]);
    l.provider("$ocLazyLoad", ["$controllerProvider", "$provide", "$compileProvider", "$filterProvider", "$injector", "$animateProvider", function (l, d, g, p, m, v) {
        function y(n, o, t) {
            if (o) {
                var i, a, l, d = [];
                for (i = o.length - 1; i >= 0; i--)if (a = o[i], e.isString(a) || (a = j(a)), a && -1 === c.indexOf(a)) {
                    var f = -1 === r.indexOf(a);
                    if (l = h(a), f && (r.push(a), y(n, l.requires, t)), l._runBlocks.length > 0)for (u[a] = []; l._runBlocks.length > 0;)u[a].push(l._runBlocks.shift());
                    e.isDefined(u[a]) && (f || t.rerun) && (d = d.concat(u[a])), $(n, l._invokeQueue, a, t.reconfig), $(n, l._configBlocks, a, t.reconfig), s(f ? "ocLazyLoad.moduleLoaded" : "ocLazyLoad.moduleReloaded", a), o.pop(), c.push(a)
                }
                var g = n.getInstanceInjector();
        ...
        x.push = function (e) {
            ...
            e.isDefined(n.modules) && (e.isArray(n.modules) ? e.forEach(n.modules, function (e) {
                _[e.name] = e
            }) : _[n.modules.name] = n.modules), e.isDefined(n.debug) && (O = n.debug), e.isDefined(n.events) && (b = n.events)
            ...
            var l = function d(n) {
                if (-1 === r.indexOf(n)) {
                    r.push(n);
                    var o = e.module(n);
                    $(null, o._invokeQueue, n), $(null, o._configBlocks, n), e.forEach(o.requires, d)
                }
            };
        ...
        this.$get = ["$log", "$rootElement", "$rootScope", "$cacheFactory", "$q", function (n, o, t, u, l) {
            function d(e) {
                var r = l.defer();
                return n.error(e.message), r.reject(e), r.promise
            }

            var g, p = u("ocLazyLoad");
            return O || (n = {}, n.error = e.noop, n.warn = e.noop, n.info = e.noop), w.getInstanceInjector = function () {
                return g ? g : g = o.data("$injector") || e.injector()
            }, s = function (e, r) {
                b && t.$broadcast(e, r), O && n.info(e, r)
            }, {
                _broadcast: s, _$log: n, _getFilesCache: function () {
                    ...
                    return t = s.getRequires(o), e.forEach(t, function (o) {
                        if (e.isString(o)) {
                            ...
                            if (null === t)return void x.push(o);
                            o = t
                        }
                        ...
                        if (e.isArray(o) ? o = {files: o} : e.isObject(o) && o.hasOwnProperty("name") && o.name && (s.setModuleConfig(o), x.push(o.name)), e.isDefined(o.files) && 0 !== o.files.length) {
                    ...
                    var r = void 0 === arguments[1] ? {} : arguments[1], o = this, t = l.defer();
                    ...
                    if (i.length > 0) {
                        var s = i.slice(), u = function d(e) {
                            x.push(e), o._loadDependencies(e, r).then(function () {
                                try {
                                    c = [], y(w, x, r)
                                } catch (e) {
    ...
    e.module("oc.lazyLoad").directive("ocLazyLoad", ["$ocLazyLoad", "$compile", "$animate", "$parse", function (n, r, o, t) {
        return {
            restrict: "A", terminal: !0, priority: 1e3, compile: function (i) {
                var a = i[0].innerHTML;
                return i.html(""), function (s, u, c) {
                    var l = t(c.ocLazyLoad);
                    s.$watch(function () {
                        return l(s) || c.ocLazyLoad
                    }, function (t) {
    ...
    e.module("oc.lazyLoad").config(["$provide", function (n) {
        n.decorator("$ocLazyLoad", ["$delegate", "$q", function (n, r) {
            return n.filesLoader = function (o) {
                var t = void 0 === arguments[1] ? {} : arguments[1], i = [], a = [], s = [], u = [], c = null, l = n._getFilesCache();
                ...
                var t, i = void 0 === arguments[1] ? {} : arguments[1], a = this, s = null, u = [], c = r.defer(), l = e.copy(o), d = e.copy(i);
    ...
    "use strict";
    e.module("oc.lazyLoad").config(["$provide", function (e) {
        e.decorator("$ocLazyLoad", ["$delegate", "$q", function (e) {
            return e.jsLoader = require, e
        }])
    }])
}(angular), function (e) {
    "use strict";
    ...
    if (0 === t)return -1;
    var i = +n || 0;
    if (1 / 0 === Math.abs(i) && (i = 0), i >= t)return -1;
